...
void TestParseCondition() {
    ...
    Assert(root->Evaluate({-1,-1,1}, ""), "Parse condition -2");
    Assert(root->Evaluate({0,9,5}, "dgfdfgs"), "Parse condition -1");
    Assert(root->Evaluate({1999,325,141}, "AAAAAA"), "Parse condition -0");
